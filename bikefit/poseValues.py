    ...
    def get_front_body(cls) -> list:
        ...
        return [
            ...
            ],
            {
                ...
                'hight_part_left':[
                    cls.LEFT_HIP, cls.RIGHT_SHOULDER, cls.LEFT_SHOULDER, False
                ],
                'hight_part_right':[
                    cls.RIGHT_HIP, cls.LEFT_SHOULDER, cls.RIGHT_SHOULDER, False
                ],
                'hight_arm_left':[
                    cls.LEFT_HIP, cls.LEFT_WRIST, cls.LEFT_SHOULDER, True
                ],
                'hight_arm_right':[
                    cls.RIGHT_HIP, cls.RIGHT_WRIST, cls.RIGHT_SHOULDER, True
                ],
            },
            keys_to_special_moments
        ]
